                ...
                <div class="product_content2">
                  <ul class="pc1">
                    ...
                    <li class="h37" title="请输入打折后的价格，保持平台价格与淘宝价格一致"><img src="<?php echo VERSION2;?>taskcss/c12.jpg" alt="">商品价格：(包含邮费)
                      <input type="text" id="txtPrice" onchange="needMinLi()" name="txtPrice" class="inputp inputxt" datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/" nullmsg="请再商品价格！" errormsg="价格必须为整数">
                    </li>
