<div class="myLink" style="width: 500px; border:2px dashed #99C1F5; margin:20px auto;">
    <div style="width: 486px; line-height:25px; color:red; margin:0 auto; padding: 10px 0; font-weight:bold;">
        您的推广链接为：<br />
        <?php
...
<style>
.bbg6{width:500px;height:100%; margin:0 auto; margin-top:10px;font-size:12px;color:#959595;text-align:left;}
