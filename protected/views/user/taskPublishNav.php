        <div id="menu_div" data-step="1" data-intro="您可以选择您想发布的任务类型" class=""> 
            <a <?php echo Yii::app()->controller->id=="user" && $this->getAction()->getId()=="taskPublishPT"?"class='on'":"";?> href="<?php echo $this->createUrl('user/taskPublishPT');?>" style="border-left:none">普通任务</a> 
            <a <?php echo Yii::app()->controller->id=="user" && $this->getAction()->getId()=="taskPublishLU"?"class='on'":"";?> href="<?php echo $this->createUrl('user/taskPublishLU');?>">来路搜索任务</a> 
