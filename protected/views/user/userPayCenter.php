         ...
         <div class="d_qie3">
         	<ul class="d_zhcz clearfix">
                ...
                <li class="yh"><p>支付宝充值</p><span style="color: #fff;">（免手续费）</span></li>
            </ul>
            <div class="d_yhyinchang">
            	<!--<div class="d_cz clearfix d_yhhide">
                    <ul class="d_yinhang clearfix">
                        <li><img src="<?php echo VERSION2;?>img/yh1.jpg" /></li>
                        <li><img src="<?php echo VERSION2;?>img/yh2.jpg" /></li>
                        <li><img src="<?php echo VERSION2;?>img/yh3.jpg" /></li>
                        <li><img src="<?php echo VERSION2;?>img/yh4.jpg" /></li>
                        <li><img src="<?php echo VERSION2;?>img/yh5.jpg" /></li>
                        <li><img src="<?php echo VERSION2;?>img/yh6.jpg" /></li>
                        <li><img src="<?php echo VERSION2;?>img/yh7.jpg" /></li>
                        <li><img src="<?php echo VERSION2;?>img/yh8.jpg" /></li>
                    </ul>
                    <div class="d_jine clearfix">
                        <p>充值金额：</p>
                        <input value="100" class="d_je_input" />
                        <a class="d_jinea" href="#">点击充值</a>
                    </div>
                </div>-->
                <?php
                ...
                <div class="d_cz clearfix">
                    <div class="d_cz_left">
                        <div class="d_czzhanghao clearfix"><p class="d_zhp">支付宝收款账号：</p><span class="d_zhspan"><?php echo $ptConfig->sk_alipay_no;?></span></div>
                        <div class="d_czxingming clearfix"><p>支付宝收款姓名：</p><span class="d_czn"><?php echo $ptConfig->sk_alipay_name;?></span><span class="d_name1">转账时请核实收款姓名</span></div>
            ...
            <div class="d_shuoming">
            	<p class="d_shuoming-1">①、支付宝充值目前为自助入账。</p>
                <p>②、转账充值时请备注您的用户名。</p>
                <p>③、转账完毕后，在此页面验证支付宝交易号将会自动到账。</p>
                <p>④、充值金额不限，您可以任意转账，手机支付宝转账免手续费。</p>
                			...
                			success:function(msg)
                			{
                				if(msg=="SUCCESS")//安全码正确
                                {
                                    ...
                                    $.ajax({
                            			...
                            			data:{"businessRecord":$(".businessRecord").val()},
                            			success:function(msg)
                            			{
                            			     if(msg=="SUCCESS")//充值成功
                                             {
