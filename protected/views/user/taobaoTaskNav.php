    <?php
        ...
        //已发任务方法名数组
        $taobaoOutTaskActionArr=array('taobaoOutTask','taobaoOutTaskStop','taobaoOutTaskComplete','taobaoOutTaskAllList','taobaoOutTaskStop2');
    ?>
    <div class="dtNav">
        <div class="dtNav_cen clearfix">
            ...
            <ul class="dtLis">
                ...
                <li <?php echo Yii::app()->controller->id=="user" && in_array($this->getAction()->getId(),$taobaoOutTaskActionArr)?"class='on'":"";?>><a href="<?php echo $this->createUrl('user/taobaoOutTaskStop2');?>">已发任务</a></li>
