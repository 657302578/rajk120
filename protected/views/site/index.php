    <div class="banNer"><!--首页幻灯-->
        <ul class="rslides" id="slider">
          ...
          <li style="background: url(<?php echo VERSION2;?>img/01.jpg) no-repeat center top;">
          </li>
          <li style="background: url(<?php echo VERSION2;?>img/02.jpg) no-repeat center top;">
          </li>
        </ul>
        <!--登录区域-->
    ...
    <div id="task">
      <div class="task_main_bg">
        <div class="plane"> <img src="<?php echo VERSION2;?>img/plane.png" alt=""/> </div>
        <div class="t1">
