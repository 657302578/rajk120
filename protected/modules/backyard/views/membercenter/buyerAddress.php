...
<form method="get" action="">
    <input type="text" name="username" placeholder="请输入用户名" style="text-indent: 5px; color: #666; font-size:14px; width:260px;" /> <select name="id_is_check"><option value="">请选择身份审核状态</option><option value="1">未审核</option><option value="2">审核通过</option><option value="3">审核未通过</option></select>　<button type="submit" class="btn btn-sm btn-success" border="0" id="reg_submit"><i class="fa fa-dot-circle-o"></i>&nbsp;搜索</button>
</form>
  <br />
