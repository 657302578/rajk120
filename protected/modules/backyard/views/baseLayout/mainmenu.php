            ...
            <div class="sidebar ">
				...
				<div class="sidebar-collapse">
					...
					<div class="sidebar-menu">						
						<ul class="nav nav-sidebar">
							...
							<li><a href="http://www.fromphp.cn" target="_blank"><i class="fa fa-picture-o"></i><span class="text"> 官方网站</span></a></li>
						</ul>
					</div>					
				</div>
				<div class="sidebar-footer">					
					...
					<ul class="sidebar-terms">
						<li><a href="http://www.fromphp.cn/xitongjieshao/" target="_blank">关于</a></li>
                        <li><a href="http://www.fromphp.cn/goumaichanpin/" target="_blank">购买</a></li>
						<li><a href="http://www.fromphp.cn/lianxiwomen/" target="_blank">帮助</a></li>
                        <li><a href="http://www.fromphp.cn/lianxiwomen/" target="_blank">联系</a></li>
					</ul>
					
					<div class="copyright text-center">
						<small>SUPPORT <i class="fa fa-coffee"></i> <a href="http://www.fromphp.cn/" title="www.fromphp.cn" target="_blank">FROMPHP.CN</a></small>
					</div>					
				</div>	
