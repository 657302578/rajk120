                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><div align="center">提现银行卡信息</div></th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><div align="center"><font style="color:red; font-size:14px; foint-weight:bold;"><?php echo $item->number;?></font>&nbsp;&nbsp;元</div></td>
                                <td><div align="center"><?php echo @$bankInfo->truename;?></div></td>
                                <td><div align="center">
                                    <div class="bankItem" lang="<?php echo $bankInfo->id;?>" style="background: url(<?php echo VERSION2.'img/bankimg/'.$bankInfo->bankCatalog.'.jpg';?>) no-repeat center top;">
                                        <div class="bankCount">(<?php echo $bankInfo->bankAccount;?>)</div>
