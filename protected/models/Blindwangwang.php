...
class Blindwangwang extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('userid, wangwang, ip, blindtime', 'required'),
			array('userid, statue, blindtime, updatetime', 'numerical', 'integerOnly'=>true),
			array('wangwang, ip', 'length', 'max'=>100),
			array('wangwanginfo', 'safe'),
