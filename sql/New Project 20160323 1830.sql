...
CREATE TABLE `zxjy_usertasklist` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户申请的任务列表';
...
INSERT INTO `zxjy_usertasklist` (`id`,`uid`,`task_id`,`user_wangwang`,`accept_time`,`state`) VALUES 
 (4,307,320,'zhang_hong_kun','2016-03-23 11:58:51',0),
 (5,307,308,'zhang_hong_kun','2016-03-23 15:29:35',0),
 (6,307,307,'zhang_hong_kun','2016-03-23 15:29:47',0),
 (7,307,306,'zhang_hong_kun','2016-03-23 15:30:10',0),
 (8,307,305,'zhang_hong_kun','2016-03-23 17:02:04',0);
